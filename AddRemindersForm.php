...
<div class="login-page">
   <div class="form">
    <form class="login-form" action="AddReminders.php" method="post">
    <select name='EventAssignedTo'>
  <option value="">Select Building</option>
<?php   while($row = $result->fetch_assoc()){
  echo "<option value='{$row["BuildingID"]}'>{$row["BuildingName"]}</option>";}?>   
</select> 
       <input type="text" name="NameofEvent" placeholder="Name of the Reminder"/>
	   <input type="text" name="EventText" placeholder="Details"/>
